# This Step 8 is an optional step to create the segmented image of the registered image for VoxelMorph. 
...
for val_i in list_id:
    ...
    # Providing the Registered Image Directory for Segmentation
    exhale_path = data_directory + 'reg_copd' + str(id) + '_eBHCT.nii.gz'
 
    # Obtaining the Segmented Lung Volumes for Registered Image
    exhale_seg = morphological_segment(exhale_path)
    segmented_exhale_path = "{}seg_reg_copd{}_eBHCT.nii.gz".format(data_directory, id)
